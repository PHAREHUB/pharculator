...
def build_figure(report: LoadReport, sample: RegionSample):
    """Build the meridional + dayside-zoom matplotlib figure and return it.

    The caller is responsible for saving and/or closing the figure.
    """
...
def make_figure(report: LoadReport, sample: RegionSample,
    ...
    """CLI helper: build the figure, save to disk, close it, return the path."""
    fig = build_figure(report, sample)
