...
def make_figure_3d(report: LoadReport, sample: RegionSample,
    ...
    """Render a 3D figure of the PIC levels + MP + BS + Earth.

    `png_paths` is an iterable of (camera_preset_name, output_png_path).
    Returns the html_path.
    """
